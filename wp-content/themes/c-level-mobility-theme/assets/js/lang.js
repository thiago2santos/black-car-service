...
(function () {
  ...
  const translations = {
    ...
    es: {
      ...
      "hero.note":
        "Conductor brasileño con experiência en atención ejecutiva, fluente en portugués, con inglés y español básico para recibir huéspedes y ejecutivos internacionales.",
      "hero.cardTitle":
      ...
      "business.benefit3Body":
        "Ajustes de ruta e horario según su necesidad, con un único ponto de contacto para todos los viajes.",
      ...
      "contact.sidebarStep3":
        "Tras su confirmación, el horário se reserva y confirmamos los detalles antes del embarque.",
      "contact.sidebarNote":
