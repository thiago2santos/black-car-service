...
3. Abra o arquivo `outros/scripts/google-sheets-webapp.gs` deste projeto, copie todo o conteúdo e cole no editor do Apps Script.
...
1. Abra o arquivo `4.canais/site-institucional/wordpress/wp-content/themes/c-level-mobility-theme/front-page.php`.
...
- **“Configure a URL de envio”** ao enviar: você ainda não preencheu `data-submit-url` no formulário de `4.canais/site-institucional/wordpress/wp-content/themes/c-level-mobility-theme/front-page.php` com a URL da Web App.
