 ...
 * 7. Na landing, no <form>, preencha o atributo data-submit-url com essa URL
 *    no arquivo 4.canais/site-institucional/wordpress/wp-content/themes/c-level-mobility-theme/front-page.php.
 *
...
function createThankYouPage() {
  // URL base da sua landing em WordPress (ex.: https://seusite.com/)
